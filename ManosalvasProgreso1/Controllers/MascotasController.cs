...
namespace ManosalvasProgreso1.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public MascotasController(ManosalvasProgreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMascota,Nombre,Raza,Color,Sexo,IdPropietario,edad")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMascota,Nombre,Raza,Color,Sexo,IdPropietario,edad")] Mascota mascota)
        {
